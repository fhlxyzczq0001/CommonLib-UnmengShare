 ...
 * PullToRefresh上拉加载动画
 */
public class PullToRefreshFoot_Loading_Layout extends LoadingLayoutBase{
    ...
    public PullToRefreshFoot_Loading_Layout(Context context) {
        this(context, PullToRefreshBase.Mode.PULL_FROM_START);
    }

    public PullToRefreshFoot_Loading_Layout(Context context, PullToRefreshBase.Mode mode) {
        super(context);
