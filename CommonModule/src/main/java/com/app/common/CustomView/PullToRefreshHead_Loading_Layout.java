package com.app.common.CustomView;
 ...
 */
public class PullToRefreshHead_Loading_Layout extends LoadingLayoutBase{
    ...
    public PullToRefreshHead_Loading_Layout(Context context) {
        this(context, PullToRefreshBase.Mode.PULL_FROM_START);
    }

    public PullToRefreshHead_Loading_Layout(Context context, PullToRefreshBase.Mode mode) {
        super(context);
    ...
    public final void reset() {
        ...
        mPersonImage.setImageResource(R.mipmap.icon_refresh_loading1);
        if (mGoodsImage.getVisibility() == View.VISIBLE) {
            mGoodsImage.setVisibility(View.INVISIBLE);
        }
    }
