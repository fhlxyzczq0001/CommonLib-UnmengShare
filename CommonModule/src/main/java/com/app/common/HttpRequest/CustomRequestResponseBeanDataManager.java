...
public class CustomRequestResponseBeanDataManager {
    ...
    Dialog dialog;
    public CustomRequestResponseBeanDataManager() {
     ...
     */
    public void requestPost(final Context context, final String url, Map<String, String> mParams, final ResultDataListener resultListener, final boolean isLoadingDialog) {
     ...
     * @param isLoadingDialog
     */
    public void requestGet(final Context context, String url, final ResultDataListener resultListener, final boolean isLoadingDialog) {
        HttpRequestManager httpRequestManager =new HttpRequestManager(new HttpOnNextListener() {
            @Override
            public void onNext(String resulte, String mothead) {
                Request_Bean request_Bean = JSONObject.parseObject(resulte, Request_Bean.class);
