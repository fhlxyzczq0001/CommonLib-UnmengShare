...
public class HttpRequestManager {
    /*单利对象*/
    private volatile static HttpRequestManager INSTANCE;
    /*单利对象*/
    ...
    public HttpRequestManager(HttpOnNextListener onNextListener, Context appCompatActivity) {
    ...
    public void doHttpDeal(BaseApi basePar) {
        ...
        Retrofit retrofit= CommonApplication.getInstance().getRetrofit(basePar);
