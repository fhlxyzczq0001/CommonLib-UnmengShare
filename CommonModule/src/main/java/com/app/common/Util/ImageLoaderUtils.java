...
public class ImageLoaderUtils extends Application{
   ...
   /* public static final String RES_ASSETS = "assets://";
    ...
    public void displayImage(String url, ImageView imageView){
        ...
        Glide.with(CommonApplication.getApplication())
                .load(url)
                .placeholder(R.mipmap.icon_no_image)//默认加载图片
                .error(R.mipmap.icon_no_image)//错误图片
                .skipMemoryCache(true)//跳过内存缓存
                .diskCacheStrategy(DiskCacheStrategy.ALL)//硬盘缓存策略
                .animate(R.anim.item_alpha_in)//自定义加载动画
                .into(imageView);
    }
    ...
    public void displayImage(String url, ImageView imageView,int radius){
        ...
        Glide.with(CommonApplication.getApplication())
                ...
                .diskCacheStrategy(DiskCacheStrategy.ALL)//硬盘缓存策略
                .animate(R.anim.item_alpha_in)//自定义加载动画
                .transform(new GlideRoundTransform(CommonApplication.getApplication(), radius))
                .into(imageView);
    }
