...
public class Main_Home_Menu_Adapter extends SuperAdapter<CommonMenuBean> {
    ProjectUtil_Presenter_Interface mProjectUtil_presenter_interface;
    public Main_Home_Menu_Adapter(Context context, List<CommonMenuBean> items) {
        super(context, items, R.layout.main_item_home_other_function_menu_layout);
        ...
        if (holder instanceof ViewHolder) {
            ...
            holder1.rippleViewItemLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    mProjectUtil_presenter_interface.urlIntentJudge(mContext,bean.getUrl(),bean.getTitle());
                }
            });
        }
    }
