...
public class Main_URL_Menu_Adapter extends SuperAdapter<CommonMenuBean> {
    ProjectUtil_Presenter_Interface mProjectUtil_presenter_interface;
    public Main_URL_Menu_Adapter(Context context, List<CommonMenuBean> items) {
        super(context, items, R.layout.main_item_url_menu_layout);
